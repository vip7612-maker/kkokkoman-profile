...
export default async function CaseDetailPage({
  ...
  const ytEmbed = item.youtubeUrl ? youtubeEmbedUrl(item.youtubeUrl) : null;
  ...
  return (
    <article className="mx-auto max-w-3xl px-5 py-12 md:py-20">
      ...
      {ytEmbed && (
        <div className="mt-8 aspect-video w-full overflow-hidden rounded-2xl border border-[color:var(--color-line)] bg-black">
          <iframe
            src={ytEmbed}
            title={`${item.title} 영상`}
